...
// const createBoard = (values: CreateValues) => {
//    const { name, columns } = values;
...
// function submit(values: UpdateValues): void;
// function submit(values: CreateValues): void;
// function submit(values: UpdateValues | CreateValues): void {
//    const { name, columns } = values;

//    const submitColumns = columns.map((column) => ({
//       id: column.id, // default to an empty string if id is not present
//       name: column.name,
//    }));

//    const submitValues: CommonValues = {
//       name,
//       columns: submitColumns,
//    };

//    // Additional properties for CreateValues
//    if (!isUpdate) {
//       submitValues.category = '';
//    }
